...
echo "<th class=column100 column13 data-column=column12>University</th>";
echo "<th class=column100 column14 data-column=column13>Aggregate</th>";
echo "<th class=column100 column15 data-column=column14>Course</th>";
echo "<th class=column100 column16 data-column=column15>Photo</th>";
...
echo "<th class=column100 column1 data-column=column2>Percentage</th>";
echo "</tr>";
...
for($i=0;$i<$row2;$i++)
{
    ...
    echo "<tr class=row100 >";
    echo "<td class=column100 column15 data-column=column1>".$arr_educationprofile[$i]["qualification"]."</td>";
    echo "<td class=column100 column15 data-column=column2>".$arr_educationprofile[$i]["percentage"]."</td>";
    echo "</tr>";
}
echo "</table>";
...
{
    echo "<center>";
       echo "<h1>";echo "<br>";echo "<br>";
       echo "Skills Not Found";echo "</h1>";
        echo "<center>";
}
 else {
...
echo "<table class=tab>";
echo "<tr class=row100 head>";
echo "<th class=column100 column1 data-column=column1>Skills</th>";
echo "</tr>";
for($i=0;$i<$row3;$i++)
{
    
    echo "<tr>";
    echo "<td class=column100 column15 data-column=column1>".$arr_studentskills[$i]["additionalskills"]."</td>";
    echo "</td>";
    echo "</tr>";
}
