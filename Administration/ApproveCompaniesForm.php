...
$stmt=$conn->prepare("select * from company where approvalstatus='NA'");
$stmt->execute();
...
if($rows==0)
{
    ...
    echo "<h2>All Companies Are Approved</h2>";
    echo "</center>";
...
echo "<th class=column100 column5 data-column=column5>Endorsement</th>";
echo "</tr>";
for($i=0;$i<$rows;$i++)
{
    ...
    echo "<a href=ApproveCompanies.php?param_companycode=$companycode>Approve</a>";
    echo "</td>";
    echo "</tr>";
