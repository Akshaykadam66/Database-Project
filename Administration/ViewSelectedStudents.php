...
echo "<th class=column100 colum9 data-column=column9>Completion Year </th>";
...
echo "<th class=column100 column12 data-columncolumn12>DOB</th>";
...
for($i=0;$i<$row;$i++)
{
   ...
   echo "<tr class=row100>";
    ...
    echo "<td class=column100 column9 data-columncolumn9>".$arr_student[$i]["completionin"]."</td>";
