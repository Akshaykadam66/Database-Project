            ...
            <div class="row">
              <div class="col-md-7">
                <ul class="list-inline top-contacts">
                  <li>
                    <i class="fa fa-envelope"></i> Email:<b>akshaymk1999@gmail.com</b></a>
                  </li>
                  <li>
                    <i class="fa fa-phone"></i> Hotline: <b>8867212396</b>
                  </li>
                </ul>
              </div> 
              <div class="col-md-5">
...
======================================================-->
    <div id="home-p" class="home-p pages-head2 text-center">
      <div class="container">
        <h1 class="wow fadeInUp" data-wow-delay="0.1s">"Hire Character Train Skill"</h1>
        <p></p>
      </div><!--/end container-->
    </div> 
